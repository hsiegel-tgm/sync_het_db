...
public class ChangeListenerPostgres implements Runnable, Mapper {
	private PostgresConnection m_connectionobj;
	private String QUERY = "Select * from logged";
	private Mapper m_mapper;
	
	public ChangeListenerPostgres(String db,String host,String user,String pw){
		m_connectionobj = new PostgresConnection(db,host,user,pw);
