...
public class Starter {
	public static void main(String arg[]){
		if(arg.length < 6){
			...
			String db_name = arg[6];

			
			if(db_type.equals("mysql")){
				String name = db_name;
				MysqlConnection mysql_connection = new MysqlConnection(db,host,user,pw,db_name);
				...
				String name = db_name;
				PostgresConnection pg_connection = new PostgresConnection(db,host,user,pw,db_name);
			...
			//TODO connection abstract?
			//TODO Change Listener abtract?
			//TODO Comment Change Listener Pg
